...
bool TypeChecker::visit(FunctionDefinition const& _function)
{
	...
	{
		if (_function.isFree())
			m_errorReporter.syntaxError(0000_error, _function.location(), "Free functions cannot be virtual.");
	...
	if (_function.overrides() && _function.isFree())
		m_errorReporter.syntaxError(0000_error, _function.location(), "Free functions cannot override.");
	...
	if (_function.isPayable())
	{
		if (_function.libraryFunction())
			...
			m_errorReporter.typeError(0000_error, _function.location(), "Free functions cannot be payable.");
...
bool TypeChecker::visit(MemberAccess const& _memberAccess)
{
	...
	// TODO should be scope, not contract
